...
class Configurer(pulumi.ComponentResource):
    ...
    def aws_provider(__self__) -> pulumi_aws.Provider:
        ...
        return pulumi.runtime.call('awsconf:index:Configurer/awsProvider', __args__, res=__self__, typ=Configurer.AwsProviderResult, plainResourceField='aws_provider')
